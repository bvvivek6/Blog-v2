...
function generateReplyPrompt(comment) {
  ...
  const content = comment.content || "No content provided";
  return `You're replying to a blog comment by ${authorName}. The comment says ${content} Write a thoughtful , consise and relevant reply to this comment.`;
}
